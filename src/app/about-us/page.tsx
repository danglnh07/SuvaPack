...
export default function AboutUs() {
    return (
        <>
                ...
                <div className="grid grid-cols-12 gap-gutter items-center">
                    <div className="col-span-12 md:col-span-8">
                        ...
                        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl leading-relaxed">
                            We believe that the most beautiful products are those that leave the smallest footprint. SavaPack is born from the intersection of artisanal craft and environmental responsibility.
                        </p>
                    </div>
                </div>
            </section>
            <section className="py-xl px-xl max-w-container-max mx-auto">
                <div className="grid grid-cols-12 gap-gutter items-center">
                    <div className="col-span-12 md:col-span-5 order-2 md:order-1 relative aspect-4/5">
                        <Image
                            src="/about-us.jpg" alt="about us image" fill loading="eager"
